...
@app.get("/api")
def api_root():
    return {"app":"Nicole Puzzle Coach API","version":"6.10.9","status":"online","dashboard":"/dashboard","docs":"/docs"}
...
def pwa_service_worker():
    return Response(content="""const CACHE_NAME='nicole-puzzle-coach-v6109';
...
@app.get("/health")
def health(): return {"status":"ok","version":"6.10.9"}
